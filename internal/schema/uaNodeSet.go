...
// Package schema provides embedded OPC UA schema files and XML type definitions.
//
// This is an advanced public package (Tier 2). Most users interact with
// NodeSet data through the server.Server import API. Direct use of this
// package is needed only for custom NodeSet loading or schema inspection.
package schema
