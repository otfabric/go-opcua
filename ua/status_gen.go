...
var (
	...
	StatusGoodEditedDependentValueChanged                              StatusCode = 0x01160000
	StatusGoodEditedDominantValueChanged                               StatusCode = 0x01170000
	StatusGoodEditedDominantValueChangedDependentValueChanged          StatusCode = 0x01180000
	StatusBadEditedOutOfRange                                          StatusCode = 0x81190000
	StatusBadInitialValueOutOfRange                                    StatusCode = 0x811A0000
	StatusBadOutOfRangeDominantValueChanged                            StatusCode = 0x811B0000
	StatusBadEditedOutOfRangeDominantValueChanged                      StatusCode = 0x811C0000
	StatusBadOutOfRangeDominantValueChangedDependentValueChanged       StatusCode = 0x811D0000
	StatusBadEditedOutOfRangeDominantValueChangedDependentValueChanged StatusCode = 0x811E0000
...
var StatusCodes = map[StatusCode]StatusCodeDesc{
	...
	StatusGoodEditedDependentValueChanged:                              {Name: "StatusGoodEditedDependentValueChanged", Text: "It is delivered with a dominant Variable value when a dependent Variable has changed but the change has not been applied."},
	StatusGoodEditedDominantValueChanged:                               {Name: "StatusGoodEditedDominantValueChanged", Text: "It is delivered with a dependent Variable value when a dominant Variable has changed but the change has not been applied."},
	StatusGoodEditedDominantValueChangedDependentValueChanged:          {Name: "StatusGoodEditedDominantValueChangedDependentValueChanged", Text: "It is delivered with a dependent Variable value when a dominant or dependent Variable has changed but change has not been applied."},
	StatusBadEditedOutOfRange:                                          {Name: "StatusBadEditedOutOfRange", Text: "It is delivered with a Variable value when Variable has changed but the value is not legal."},
	StatusBadInitialValueOutOfRange:                                    {Name: "StatusBadInitialValueOutOfRange", Text: "It is delivered with a Variable value when a source Variable has changed but the value is not legal."},
	StatusBadOutOfRangeDominantValueChanged:                            {Name: "StatusBadOutOfRangeDominantValueChanged", Text: "It is delivered with a dependent Variable value when a dominant Variable has changed and the value is not legal."},
	StatusBadEditedOutOfRangeDominantValueChanged:                      {Name: "StatusBadEditedOutOfRangeDominantValueChanged", Text: "It is delivered with a dependent Variable value when a dominant Variable has changed, the value is not legal and the change has not been applied."},
	StatusBadOutOfRangeDominantValueChangedDependentValueChanged:       {Name: "StatusBadOutOfRangeDominantValueChangedDependentValueChanged", Text: "It is delivered with a dependent Variable value when a dominant or dependent Variable has changed and the value is not legal."},
	StatusBadEditedOutOfRangeDominantValueChangedDependentValueChanged: {Name: "StatusBadEditedOutOfRangeDominantValueChangedDependentValueChanged", Text: "It is delivered with a dependent Variable value when a dominant or dependent Variable has changed, the value is not legal and the change has not been applied."},
