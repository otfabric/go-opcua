...
func init() {
	...
	RegisterExtensionObject(NewNumericNodeID(0, id.BitFieldDefinition_Encoding_DefaultBinary), new(BitFieldDefinition))
	...
	RegisterExtensionObject(NewNumericNodeID(0, id.AnnotationDataType_Encoding_DefaultBinary), new(AnnotationDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.LinearConversionDataType_Encoding_DefaultBinary), new(LinearConversionDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.QuantityDimension_Encoding_DefaultBinary), new(QuantityDimension))
	RegisterExtensionObject(NewNumericNodeID(0, id.TrustListDataType_Encoding_DefaultBinary), new(TrustListDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.BaseConfigurationDataType_Encoding_DefaultBinary), new(BaseConfigurationDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.BaseConfigurationRecordDataType_Encoding_DefaultBinary), new(BaseConfigurationRecordDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.CertificateGroupDataType_Encoding_DefaultBinary), new(CertificateGroupDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.ConfigurationUpdateTargetType_Encoding_DefaultBinary), new(ConfigurationUpdateTargetType))
	RegisterExtensionObject(NewNumericNodeID(0, id.TransactionErrorType_Encoding_DefaultBinary), new(TransactionErrorType))
	RegisterExtensionObject(NewNumericNodeID(0, id.ApplicationConfigurationDataType_Encoding_DefaultBinary), new(ApplicationConfigurationDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.ApplicationIdentityDataType_Encoding_DefaultBinary), new(ApplicationIdentityDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.EndpointDataType_Encoding_DefaultBinary), new(EndpointDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.ServerEndpointDataType_Encoding_DefaultBinary), new(ServerEndpointDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.SecuritySettingsDataType_Encoding_DefaultBinary), new(SecuritySettingsDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.UserTokenSettingsDataType_Encoding_DefaultBinary), new(UserTokenSettingsDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.ServiceCertificateDataType_Encoding_DefaultBinary), new(ServiceCertificateDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.AuthorizationServiceConfigurationDataType_Encoding_DefaultBinary), new(AuthorizationServiceConfigurationDataType))
	...
	RegisterExtensionObject(NewNumericNodeID(0, id.ActionTargetDataType_Encoding_DefaultBinary), new(ActionTargetDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.PublishedActionDataType_Encoding_DefaultBinary), new(PublishedActionDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.ActionMethodDataType_Encoding_DefaultBinary), new(ActionMethodDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.PublishedActionMethodDataType_Encoding_DefaultBinary), new(PublishedActionMethodDataType))
	...
	RegisterExtensionObject(NewNumericNodeID(0, id.DtlsPubSubConnectionDataType_Encoding_DefaultBinary), new(DtlsPubSubConnectionDataType))
	...
	RegisterExtensionObject(NewNumericNodeID(0, id.LldpManagementAddressTxPortType_Encoding_DefaultBinary), new(LldpManagementAddressTxPortType))
	RegisterExtensionObject(NewNumericNodeID(0, id.LldpManagementAddressType_Encoding_DefaultBinary), new(LldpManagementAddressType))
	RegisterExtensionObject(NewNumericNodeID(0, id.LldpTlvType_Encoding_DefaultBinary), new(LldpTlvType))
	...
	RegisterExtensionObject(NewNumericNodeID(0, id.LogRecord_Encoding_DefaultBinary), new(LogRecord))
	RegisterExtensionObject(NewNumericNodeID(0, id.LogRecordsDataType_Encoding_DefaultBinary), new(LogRecordsDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.SpanContextDataType_Encoding_DefaultBinary), new(SpanContextDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.TraceContextDataType_Encoding_DefaultBinary), new(TraceContextDataType))
	RegisterExtensionObject(NewNumericNodeID(0, id.NameValuePair_Encoding_DefaultBinary), new(NameValuePair))
	...
	RegisterExtensionObject(NewNumericNodeID(0, id.ReadEventDetails2_Encoding_DefaultBinary), new(ReadEventDetails2))
	RegisterExtensionObject(NewNumericNodeID(0, id.SortRuleElement_Encoding_DefaultBinary), new(SortRuleElement))
	RegisterExtensionObject(NewNumericNodeID(0, id.ReadEventDetailsSorted_Encoding_DefaultBinary), new(ReadEventDetailsSorted))
	...
	RegisterExtensionObject(NewNumericNodeID(0, id.HistoryModifiedEvent_Encoding_DefaultBinary), new(HistoryModifiedEvent))
