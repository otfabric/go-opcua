// Code generated by "stringer -type AccessLevelExType,AccessLevelType,AccessRestrictionType,ActionState,AlarmMask,ApplicationType,AttributeID,AttributeWriteMask,AxisScaleEnumeration,BrokerTransportQoS,BrowseDirection,BrowseResultMask,ChassisIDSubtype,ConfigurationUpdateType,ConversionLimitEnum,DataChangeTrigger,DataSetFieldContentMask,DataSetFieldFlags,DataSetOrderingType,DeadbandType,DiagnosticsLevel,Duplex,EventNotifierType,ExceptionDeviationFormat,FilterOperator,HistoryUpdateType,IDType,IdentityCriteriaType,InterfaceAdminStatus,InterfaceOperStatus,JSONDataSetMessageContentMask,JSONNetworkMessageContentMask,LldpSystemCapabilitiesMap,LogRecordMask,ManAddrIfSubtype,MessageSecurityMode,ModelChangeStructureVerbMask,MonitoringMode,NamingRuleType,NegotiationStatus,NodeAttributesMask,NodeClass,NodeIDType,OpenFileMode,OverrideValueHandling,PasswordOptionsMask,PerformUpdateType,PermissionType,PortIDSubtype,PubSubConfigurationRefMask,PubSubDiagnosticsCounterClassification,PubSubState,RedundancySupport,RedundantServerMode,SecurityTokenRequestType,ServerState,SortOrderType,StructureType,TimestampsToReturn,TrustListMasks,TrustListValidationOptions,TsnFailureCode,TsnListenerStatus,TsnStreamState,TsnTalkerStatus,TypeID,UADPDataSetMessageContentMask,UADPNetworkMessageContentMask,UserConfigurationMask,UserTokenType -output ua/enums_strings_gen.go ./ua"; DO NOT EDIT.
