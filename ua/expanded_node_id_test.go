...
func TestParseExpandedNodeID(t *testing.T) {
	cases := []struct {
		...
		// nsu error flows
		{s: "nsu=abc;i=2253", ns: []string{}, err: fmt.Errorf("%w: namespace uri nsu=abc not found in %#v", errors.ErrNamespaceNotFound, []string{})},
		{s: "nsu=abc;i=2253", ns: []string{"", "def", "xyz"}, err: fmt.Errorf("%w: namespace uri nsu=abc not found in %#v", errors.ErrNamespaceNotFound, []string{"", "def", "xyz"})},
	}
